...
<body>
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div>
        ...
        <input type="text" id="subject" name="subject" value="#000000">
    </div>
    <div>
        <label for="msg">Contenu :</label>
        <textarea type="text" id="msg" name="user_message"></textarea>
    </div>
    <div>
...
<div class="button">
<button type="submit" value="Submit"class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
        Envoyez!
      </button>
      </form>
    </div>
